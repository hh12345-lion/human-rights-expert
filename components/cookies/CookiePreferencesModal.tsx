        ...
        <label className="relative inline-flex shrink-0 cursor-pointer items-center">
          ...
          <span
            className={`relative block h-7 w-12 rounded-full transition-colors duration-200 ${
              meta.required
                ? "bg-ink/35"
                : "bg-line peer-focus-visible:ring-2 peer-focus-visible:ring-seal peer-focus-visible:ring-offset-2 peer-checked:bg-seal"
            }`}
            aria-hidden
          >
            <span
    ...
    >
      ...
      >
        <div className="border-b border-line bg-ink px-5 py-4 sm:px-6">
          <p className="text-xs font-semibold uppercase tracking-[0.12em] text-seal">Cookie settings</p>
          <h2 id="cookie-prefs-title" className="mt-1 text-lg font-bold text-white">
            Customize your preferences
          </h2>
          <p className="mt-1 text-sm text-white/75">
            Choose which cookies we may use.{" "}
            <Link href="/cookie-policy" className="text-seal hover:underline" onClick={closePreferences}>
              Cookie Policy
            </Link>
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2 border-t border-line bg-white p-4 sm:flex-row sm:flex-wrap sm:justify-end">
          <button
            ...
            ref={closeBtnRef}
            onClick={closePreferences}
            className="min-h-[44px] rounded-[4px] border border-line px-4 py-2 text-sm font-medium text-body transition hover:bg-mist"
          >
            Cancel
          </button>
          <button
            ...
            className="min-h-[44px] rounded-[4px] border border-ink px-4 py-2 text-sm font-semibold text-ink transition hover:bg-mist"
          >
          ...
          <button
            ...
            className="min-h-[44px] rounded-[4px] bg-ink px-4 py-2 text-sm font-semibold text-white transition hover:bg-ink"
          >
            Save Preferences
          </button>
          <button
            type="button"
            onClick={acceptAll}
            className="min-h-[44px] rounded-[4px] bg-seal px-4 py-2 text-sm font-semibold text-white transition hover:bg-seal-deep"
          >
            Accept All
          </button>
        </div>
